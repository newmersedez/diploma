...
namespace Diploma.ECC.Extensions
{
    ...
    /// </summary>
    public static class CurveNameExtension
    {
        public static CurveParameters GetParameters(this CurveName name, Curve curve)
        {
            switch (name)
            {
	            case CurveName.Brainpoolp160R1:
		            return new CurveParameters
		            {
			            ...
			            G = new Point(
				            BigInteger.Parse("00BED5AF16EA3F6A4F62938C4631EB5AF7BDBCDBC3", NumberStyles.HexNumber),
				            BigInteger.Parse("001667CB477A1A8EC338F94741669C976316DA6321", NumberStyles.HexNumber),
				            curve),
				...
				case CurveName.Brainpoolp192R1:
					return new CurveParameters
					{
						...
						G = new Point(
							BigInteger.Parse("00C0A0647EAAB6A48753B033C56CB0F0900A2F5C4853375FD6", NumberStyles.HexNumber),
							BigInteger.Parse("0014B690866ABD5BB88B5F4828C1490002E6773FA2FA299B8F", NumberStyles.HexNumber),
							curve),
				...
				case CurveName.Brainpoolp224R1:
					return new CurveParameters
					{
						...
						G = new Point(
							BigInteger.Parse("000D9029AD2C7E5CF4340823B2A87DC68C9E4CE3174C1E6EFDEE12C07D", NumberStyles.HexNumber),
							BigInteger.Parse("0058AA56F772C0726F24C6B89E4ECDAC24354B9E99CAA3F6D3761402CD", NumberStyles.HexNumber),
							curve),
				...
				case CurveName.Brainpoolp256R1:
					return new CurveParameters
					{
						...
						G = new Point(
							BigInteger.Parse("008BD2AEB9CB7E57CB2C4B482FFC81B7AFB9DE27E1E3BD23C23A4453BD9ACE3262", NumberStyles.HexNumber),
							BigInteger.Parse("00547EF835C3DAC4FD97F8461A14611DC9C27745132DED8E545C1D54C72F046997", NumberStyles.HexNumber),
							curve),
				...
				case CurveName.Brainpoolp320R1:
					return new CurveParameters
					{
						...
						G = new Point(
							BigInteger.Parse("0043BD7E9AFB53D8B85289BCC48EE5BFE6F20137D10A087EB6E7871E2A10A599C710AF8D0D39E20611", NumberStyles.HexNumber),
							BigInteger.Parse("0014FDD05545EC1CC8AB4093247F77275E0743FFED117182EAA9C77877AAAC6AC7D35245D1692E8EE1", NumberStyles.HexNumber), 
							curve),
				...
				case CurveName.Brainpoolp384R1:
					return new CurveParameters
					{
						...
						G = new Point(
							BigInteger.Parse("001D1C64F068CF45FFA2A63A81B7C13F6B8847A3E77EF14FE3DB7FCAFE0CBD10E8E826E03436D646AAEF87B2E247D4AF1E", NumberStyles.HexNumber), 
							BigInteger.Parse("008ABE1D7520F9C2A45CB1EB8E95CFD55262B70B29FEEC5864E19C054FF99129280E4646217791811142820341263C5315", NumberStyles.HexNumber),
							curve),
				...
				case CurveName.Brainpoolp512R1:
					return new CurveParameters
					{
						...
						G = new Point(
							BigInteger.Parse("0081AEE4BDD82ED9645A21322E9C4C6A9385ED9F70B5D916C1B43B62EEF4D0098EFF3B1F78E2D0D48D50D1687B93B97D5F7C6D5047406A5E688B352209BCB9F822", NumberStyles.HexNumber),
							BigInteger.Parse("007DDE385D566332ECC0EABFA9CF7822FDF209F70024A57B1AA000C55B881F8111B2DCDE494A5F485E5BCA4BD88A2763AED1CA2B2FA8F0540678CD1E0F3AD80892", NumberStyles.HexNumber),
							curve),
				...
				case CurveName.Nistp192:
					return new CurveParameters
					{
						...
						G = new Point(
							BigInteger.Parse("00188DA80EB03090F67CBF20EB43A18800F4FF0AFD82FF1012", NumberStyles.HexNumber),
							BigInteger.Parse("0007192B95FFC8DA78631011ED6B24CDD573F977A11E794811", NumberStyles.HexNumber),
							curve),
				...
				case CurveName.Nistp256:
					return new CurveParameters
					{
						...
						G = new Point(
							BigInteger.Parse("006B17D1F2E12C4247F8BCE6E563A440F277037D812DEB33A0F4A13945D898C296", NumberStyles.HexNumber),
				...
				case CurveName.Nistp384:
					return new CurveParameters
					{
						...
						G = new Point(
							BigInteger.Parse("00AA87CA22BE8B05378EB1C71EF320AD746E1D3B628BA79B9859F741E082542A385502F25DBF55296C3A545E3872760AB7", NumberStyles.HexNumber),
							BigInteger.Parse("003617DE4A96262C6F5D9E98BF9292DC29F8F41DBD289A147CE9DA3113B5F0B8C00A60B1CE1D7E819D7A431D7C90EA0E5F", NumberStyles.HexNumber),
							curve),
				...
				case CurveName.Nistp521:
					return new CurveParameters
					{
						...
						G = new Point(
							BigInteger.Parse("00C6858E06B70404E9CD9E3ECB662395B4429C648139053FB521F828AF606B4D3DBAA14B5E77EFE75928FE1DC127A2FFA8DE3348B3C1856A429BF97E7E31C2E5BD66", NumberStyles.HexNumber),
				...
				case CurveName.Secp160R1:
					return new CurveParameters
					{
						...
						G = new Point(
							BigInteger.Parse("004A96B5688EF573284664698968C38BB913CBFC82", NumberStyles.HexNumber),
							BigInteger.Parse("0023A628553168947D59DCC912042351377AC5FB32", NumberStyles.HexNumber),
							curve),
				...
				case CurveName.Secp160R2:
					return new CurveParameters
					{
						...
						G = new Point(
							BigInteger.Parse("0052DCB034293A117E1F4FF11B30F7199D3144CE6D", NumberStyles.HexNumber),
							BigInteger.Parse("00FEAFFEF2E331F296E071FA0DF9982CFEA7D43F2E", NumberStyles.HexNumber),
							curve),
	            ...
	            case CurveName.Secp160K1:
					return new CurveParameters
					{
						...
						G = new Point(
							BigInteger.Parse("003B4C382CE37AA192A4019E763036F4F5DD4D7EBB", NumberStyles.HexNumber),
							BigInteger.Parse("00938CF935318FDCED6BC28286531733C3F03C4FEE", NumberStyles.HexNumber),
							curve),
				...
				case CurveName.Secp192K1:
					return new CurveParameters
					{
						...
						G = new Point(
							BigInteger.Parse("00DB4FF10EC057E9AE26B07D0280B7F4341DA5D1B1EAE06C7D", NumberStyles.HexNumber),
							BigInteger.Parse("009B2F2F6D9C5628A7844163D015BE86344082AA88D95E2F9D", NumberStyles.HexNumber),
							curve),
				...
				case CurveName.Secp224R1:
					return new CurveParameters
					{
						...
						G = new Point(
							BigInteger.Parse("00B70E0CBD6BB4BF7F321390B94A03C1D356C21122343280D6115C1D21", NumberStyles.HexNumber),
							BigInteger.Parse("00BD376388B5F723FB4C22DFE6CD4375A05A07476444D5819985007E34", NumberStyles.HexNumber),
							curve),
				...
				case CurveName.Secp224K1:
					return new CurveParameters
					{
						...
						G = new Point(
							BigInteger.Parse("00A1455B334DF099DF30FC28A169A467E9E47075A90F7E650EB6B7A45C", NumberStyles.HexNumber),
							BigInteger.Parse("007E089FED7FBA344282CAFBD6F7E319F7C0B0BD59E2CA4BDB556D61A5", NumberStyles.HexNumber),
							curve),
